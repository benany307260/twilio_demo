...
public class VoiceMessage {
	...
	public static void main(String[] args) {
		...
		String phone = "+16078826021";
		VoiceMessage.call(phone);
		
	}
	
	public static String call(String phone) {
		try {
			Twilio.init(TwilioConstant.ACCOUNT_SID, TwilioConstant.AUTH_TOKEN);
			
			PhoneNumber from = new com.twilio.type.PhoneNumber(TwilioConstant.TWILIO_PHONE_HZB_15798000110);
